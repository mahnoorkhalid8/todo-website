...
# Todo App - Build and Test Commands
...
# Examples:
python -m src.main add "My Task" "Task description"
python -m src.main list
python -m src.main update 1 --title "Updated Task"
...
# Or if using pyproject.toml with dev extras:
uv sync --group dev
```
